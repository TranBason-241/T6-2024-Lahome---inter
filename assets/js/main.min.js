$(document).ready(function () {
  ...
  var myModalType_1 = new bootstrap.Modal(
    document.getElementById("modal-type-1"),
    {}
  );
  showModal = (markClick) => {
    ...
    if(targetSlide.getAttribute("id") == "p-4"){

    }else if(targetSlide.getAttribute("id") == "p-5")

    myModalType_1.show();
    setTimeout(() => {
      var swiper_modal_type_1 = new Swiper(".swiper-type-1", {
        slidesPerView: 1,
        spaceBetween: 30,
        loop: true,
        pagination: {
        ...
        navigation: {
          nextEl: ".slide-type-1-container .swiper-button-next",
          prevEl: ".slide-type-1-container .swiper-button-prev",
        },
      });
    }, 300);
  };
